...
struct PongMode : Mode {
	...
	virtual void init_grass() override;

	//----- game state -----

	glm::vec2 court_radius = glm::vec2(6.75f, 4.75f);
	glm::vec2 paddle_radius = glm::vec2(0.2f, 1.0f);
	glm::vec2 ball_radius = glm::vec2(0.2f, 0.2f);

	glm::vec2 left_paddle = glm::vec2(-0.5f, 0.0f);
	glm::vec2 right_paddle = glm::vec2(0.5f, 0.0f);

	glm::vec2 ball = glm::vec2(0.0f, 0.0f);
	glm::vec2 ball_velocity = glm::vec2(-1.0f, 0.0f);

	uint32_t grass[27][19];
